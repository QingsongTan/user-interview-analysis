...
编号：P01，女，28岁，市场运营，北京，抖音重度用户，日均使用2-3小时

【访谈内容】

Q1：你平时每天大概花多长时间在抖音上，一般在什么场景下刷？
P01：说出来有点不好意思，差不多两三个小时吧，有时候睡前刷着刷着就到凌晨一两点了。主要是上下班通勤的时候刷，地铁上那段时间大概四十分钟。碎片时间都会打开，中午吃饭、等电梯也会刷一会儿。

Q2：你一般刷什么类型的内容，觉得推荐准吗？
P01：最开始是美食，后来算法越来越准，现在推给我的都是穿搭、旅游、还有一些职场干货类的。我有时候觉得它比我还了解我自己，我随便点了几个旅游视频，第二天就给我推了一堆云南的攻略，我确实在计划去那里。但偶尔也会有特别奇怪的内容出现，感觉是哪里触发了它的误判。

Q3：有没有让你觉得不爽或者体验不好的时候？
P01：有，就是广告。你刷着刷着突然来一个直播带货，而且还不好跳过，那个感觉真的很打断。还有就是，有时候我发现我不想看某个内容，点了"不感兴趣"，过两天又给我推类似的，感觉这个功能没什么用。另外有时候同一个视频会被推好几次，有点烦。

Q4：你有在抖音上买过东西吗，体验怎么样？
P01：买过！就是被种草的，看了一个博主推荐的护肤品，当时直接跳到小黄车下单了。但说实话，也有后悔的，因为有时候看视频觉得效果很好，收到实物就一般般。现在我会多看几个不同博主的评价，不那么容易冲动消费了。退货也用过，流程还好，但如果商品是直播间秒杀价就退不回那个价了，有点坑。

Q5：你有自己发过视频或者参与互动吗？
P01：发过，但没坚持。拍了几个日常vlog，阅读量特别少，就放弃了。评论区我倒是经常参与，看到有趣的视频会发评论，也会跟别人互动。抖音的评论区氛围我觉得还挺好玩的，梗文化很浓，有时候评论比视频本身还有意思。点赞和收藏也经常用，但收藏了很多，真正再去看的很少。

Q6：如果让你用几个词描述抖音，你会怎么说？未来有什么期待或者改进建议？
P01：我会说"上瘾"、"精准"、还有"碎片化"。它很擅长抓住你的注意力，但你看完也说不出来记住了什么，就是被填满了那种感觉。希望能有一个"今天刷够了"的提醒，不是那种可以轻松关掉的，而是真的帮你管理时间的功能。还有就是直播间的氛围有时候太嘈杂了，那种"321上链接"喊麦感觉很low，影响购物体验。"""
